...
const GUIDE_SECTIONS=[
  ...
  { title:'🔔 알림 (더보기 → 마감 알림 켜기)', items:[
    ['🌅','매일 9시','오늘 할 일을 요약해서 알려줘요. "🔴 14:00 보고서 외 4건이 남아있습니다"'],
    ['⏰','마감 1시간 전','마감시간이 있는 할 일은 1시간 전에 미리 알려줘요.'],
    ['🌆','매일 17시','아직 체크 안 된 미완료 할 일을 리마인드해줘요.'],
  ...
  { title:'⋯ 더보기 메뉴', items:[
    ...
    ['📤','캘린더 내보내기','.ics 파일로 구글캘린더/아웃룩에 가져갈 수 있어요.'],
...
function updateNotifyBtn() {
  ...
  btn.title = enabled?'알림 켜짐 (9시 오늘할일 · 마감 1시간 전 · 17시 미완료)':'알림 꺼짐 (클릭하여 켜기)';
}
